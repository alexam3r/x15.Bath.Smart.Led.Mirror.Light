...
`firmware/lib/MirrorCore`: без Arduino/FreeRTOS, тестируется на ПК (`pio test -e native`, 191 тест).
...
- **v1.2.0** (текущая; на железе ещё не проверена) — плавные переходы цвета и яркости (0,5 с); затухание до
