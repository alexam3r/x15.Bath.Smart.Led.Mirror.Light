...
- **v1.3.1** (текущая; на железе ещё не проверена) — «угли» глубже: центр уголька гаснет до 10–30 % для глаза, с градиентным краем по
...
- **v1.2.2** (на железе ещё не проверена) — сенсор «Зеркало: последний эффект»: имя последнего
