...
- **Диагностика в Home Assistant** (v1.2.0) — отдельный топик `diag` раз в минуту: аптайм, уровень WiFi,
  причина последней перезагрузки, свободная и минимальная свободная память, версия прошивки. Четыре
  диагностических сенсора; в основной статус светильника не попадает, чтобы не дёргать его каждую секунду.
...
Network watchdog перезагружает ESP после 5 минут без WiFi — только когда свет выключен; простой одного MQTT перезагрузку не вызывает.
