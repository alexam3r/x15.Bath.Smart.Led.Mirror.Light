...
Прошивка (v1.4.2, модульная архитектура — см. [ARCHITECTURE.md](ARCHITECTURE.md)) оптимизирована для
...
- **v1.4.2** (текущая) — радужная змейка при каждом запуске перемешивает шесть своих цветов (красный, жёлтый,
