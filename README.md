...
Прошивка (v1.3.1, модульная архитектура — см. [ARCHITECTURE.md](ARCHITECTURE.md)) оптимизирована для
...
- **v1.3.1** (текущая; тег `v1.3.1`, проверена на зеркале 23.09.2026 — «вроде всё гуд») — «угли» глубже: центр уголька гаснет до 10–30 % для глаза, с градиентным краем по
