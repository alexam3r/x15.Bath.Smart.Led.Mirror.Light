...
`firmware/lib/MirrorCore`: без Arduino/FreeRTOS, тестируется на ПК (`pio test -e native`, 129 тестов).
...
- **v1.0.0** (текущая, `main`; проверена на железе 22.09.2026 — работает так же, как v27) — порт прошивки
  ...
  129 unit-тестов на ПК). Нумерация версий начата
