# ARCHITECTURE — Smart Mirror RGBW, прошивка v1.4.2
...
### 9.1 Размер прошивки: v27 → v1.4.2

| env | Flash (v27 baseline) | Flash (v1.4.2) | RAM (v27 baseline) | RAM (v1.4.2) |
|---|---|---|---|---|
| `esp32-s3-zero` (прод) | 719081 B | 734025 B (+14944 B, +2.08%) | 44848 B | 47352 B (+2504 B, +5.58%) |
| `esp32-s3-zero-debug` | 720725 B | 735581 B (+14856 B, +2.06%) | 44848 B | 47352 B (+2504 B, +5.58%) |
...
**Тесты (v1.4.2):** 245 на ПК (в v1.4.1 — 242, в v1.3.2 — 241, в v1.2.1 — 233) (`pio test -e native`, ~20 с), из них набор `test_soak` (~11 с) — симуляция
