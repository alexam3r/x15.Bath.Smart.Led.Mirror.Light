# ARCHITECTURE — Smart Mirror RGBW, прошивка v1.2.2
...
| env | Flash (v27 baseline) | Flash (v1.2.1) | RAM (v27 baseline) | RAM (v1.2.1) |
|---|---|---|---|---|
| `esp32-s3-zero` (прод) | 719081 B | 732185 B (+13104 B, +1.82%) | 44848 B | 47488 B (+2640 B, +5.89%) |
| `esp32-s3-zero-debug` | 720725 B | 733761 B (+13036 B, +1.81%) | 44848 B | 47488 B (+2640 B, +5.89%) |
...
**Тесты (v1.2.1):** 233 на ПК (`pio test -e native`, ~20 с), из них набор `test_soak` (~11 с) — симуляция
