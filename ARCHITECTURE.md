# ARCHITECTURE — Smart Mirror RGBW, прошивка v1.4.1
...
>
> v1.4.1 (24.09.2026): `flame` был почти незаметен — блоки шире и глубже: ровное ядро 10–12 светодиодов и
> градиент по 3–4 с каждой стороны пропорционально ядру (16–20 всего), ядро гаснет до 30 % для глаза вместо
> 60 % (§4.2).
>
...
тесты сверяют их кадры с v27 байт в байт. Мягкий край slide-анимации был в этом списке до v1.3.2; владелец
...
### 9.1 Размер прошивки: v27 → v1.4.1

| env | Flash (v27 baseline) | Flash (v1.4.1) | RAM (v27 baseline) | RAM (v1.4.1) |
|---|---|---|---|---|
| `esp32-s3-zero` (прод) | 719081 B | 733761 B (+14680 B, +2.04%) | 44848 B | 47336 B (+2488 B, +5.55%) |
| `esp32-s3-zero-debug` | 720725 B | 735313 B (+14588 B, +2.02%) | 44848 B | 47336 B (+2488 B, +5.55%) |
...
**Тесты (v1.4.1):** 242 на ПК (в v1.3.2 — 241, в v1.2.1 — 233) (`pio test -e native`, ~20 с), из них набор `test_soak` (~11 с) — симуляция
