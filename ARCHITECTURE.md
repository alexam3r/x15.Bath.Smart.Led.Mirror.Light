# ARCHITECTURE — Smart Mirror RGBW, прошивка v1.3.0
...
| `embers` | временный (v1.2.0, переделан в v1.3.0) | «угли»: около каждого восьмого светодиода — «уголёк», который по косинусу уходит до 30–50 % **для глаза** (CIE 1931) и возвращается за 1–2,5 с, соседи слева и справа — на половину глубины; каждый уголёк на своих часах (новый — с вероятностью 35 % за шаг, не ближе 3 светодиодов к другим, не больше 24 разом). 667 шагов × 30 мс ≈ 20 с; в первые секунды угольки разгораются, в последние 2,5 с новых нет — эффект сходит на нет сам. В v1.2.0 все 168 светодиодов понемногу дрожали разом в 40–100 % ШИМ (70–100 % для глаза) — получалась почти незаметная рябь |
