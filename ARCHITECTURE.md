...
```json
{"uptime_s":3723,"rssi":-61,"reset_reason":"POWERON","free_heap":231000,"min_free_heap":198000,"fw":"1.2.0"}
```
...
В HA — четыре диагностических сенсора (`ha_mirror.yaml`); буфер `DIAG_JSON_CAP` = 192 Б, при нехватке
